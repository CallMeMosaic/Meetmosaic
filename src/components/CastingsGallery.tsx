...
interface CastingsGalleryProps {
    isOpen: boolean;
    onClose: () => void;
}
...
export function CastingsGallery({ isOpen, onClose }: CastingsGalleryProps) {
    ...
    const timelineSections: TimelineSection[] = [
        ...
        },
        {
            ...
            images: [
                { id: 20, url: '/sorted_assets/cosplay/BS/BS1.jpg', title: 'Sitting and walking' },
                { id: 21, url: '/sorted_assets/cosplay/BS/BS2.jpg', title: 'Something moved!' },
                { id: 22, url: '/sorted_assets/cosplay/BS/TLU3.jpg', title: 'Drawing the Gun' },
                { id: 23, url: '/sorted_assets/cosplay/BS/TLU4.jpg', title: 'Approaching' },
                { id: 24, url: '/sorted_assets/cosplay/BS/TLU5.jpg', title: 'Spotting' },
                { id: 25, url: '/sorted_assets/cosplay/BS/TLU6.jpg', title: 'Close Up' },
                { id: 26, url: '/sorted_assets/cosplay/BS/TLU7.jpg', title: 'Done!' },
                { id: 27, url: '/sorted_assets/cosplay/BS/TLU8.jpg', title: 'Fleeing' },
                { id: 28, url: '/sorted_assets/cosplay/BS/TLU9.jpg', title: 'Nausea xD' },
                { id: 29, url: '/sorted_assets/cosplay/BS/TLU10.jpg', title: 'Cover Shot!' },
